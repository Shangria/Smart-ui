    ...
    <div className="images-container">
        ...
        <div className="left-column">
            ...
            {additionalTechnology&&additionalTechnology.map((img , i)=>
                <img key={i} src={img?.sizes?.medium} alt="technology" />  )}
        </div>
        <div className="right-column">
            <div style={{gridArea:'a0'}}>
               <p > {benefits?.google_pagespeed?.value}  </p> 
            </div>
               
                         {additionalTechnology&&additionalTechnology.map((img , i)=>
                      <div  style={{gridArea: 'a'+(i+1)}}> <img key={i} src={img?.sizes?.medium} alt="technology" /> </div> )  }
