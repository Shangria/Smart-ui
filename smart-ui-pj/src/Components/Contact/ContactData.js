...
export const contactData={
    ...
    contactInfoAve:"199-B Moskovsky Ave",
    contactInfoWD:"Monday-Friday: 09.00-23.00",
    contactInfoWeekend:"Saturday-Sunday: 11.00-16.00",
    upWorkLogo: UpWork,
    altUpWork: "UpWork",
    upWorkContact: "upwork.com/agencies/~01e25310f9dbd13dbb",
    linkedInLogo: LinkedIn,
    altLinkd:"LinkedIn",
    linkedInContact:"linkedin.com/in/smart-ui-company/",
    phoneLogo:Phone,
    altPhone:"Phone",
    phoneContact:"+38 (063) 887 84 61",
    mailLogo:Mail,
    altMail:"Mail",
